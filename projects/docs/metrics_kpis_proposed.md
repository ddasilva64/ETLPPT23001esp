...
4. **_Calculating CLV_**: To contrast with the annual customer income data (mentioned above), we have calculated the **_CLV_** in the **_CLV\_view_**. The **_CLV\_view_** will give us insights into **_individual customer value_**.
...
* **_CLV_view_** is for checking in **_DWH_**
...
* **_PB_view_** is for checking in **_DWH_**
...
* **_ISS_Customer_Product_view_** is for dimensional reduction in the **_BSC_** data model
