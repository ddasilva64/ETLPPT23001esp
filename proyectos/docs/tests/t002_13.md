...
| :------------ | :----------- | :----------- | :-------- | :-------------- |
| datawarehouse | DimCustomer  | GeographyKey | integer   | m107            | 
| datawarehouse | DimGeography | GeographyKey | integer   | **m141**        |
| datawarehouse | DimReseller  | GeographyKey | integer   | **m141**        |
