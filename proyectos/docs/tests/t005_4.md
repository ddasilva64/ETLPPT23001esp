## Test #004-4 (FactInternetSalesForecast FK <-> DimSalesTerritory PK)  
...
| :---------------- | :------------------ | :------------------- | :---------------------- | :------------------------ | :---------------------- | :--------- | :-------: | :-------: |
| FactInternetSalesForecast | DimSalesTerritoryFK | DimSalesTerritoryKey | DimSalesTerritory       | DimSalesTerritory_pkey    | DimSalesTerritoryKey    | full       | X         | X         |
...
![FK general](https://i.imgur.com/wGyFNGc.png)  
_FK general_  

<p><br></p>

![FK definition](https://i.imgur.com/nYfp0il.png)  
_FK definition_  

<p><br></p>

![FK columns](https://i.imgur.com/XIBEsdz.png)  
_FK columns_  

<p><br></p>

![FK actions](https://i.imgur.com/nD0ZqNw.png)  
_FK actions_  
...
![SQL check](https://i.imgur.com/UA2DAYp.png)  
_SQL check_  
...
![DBeaver inherits the relationship to build the ERD](https://i.imgur.com/m2IJL5T.png)
