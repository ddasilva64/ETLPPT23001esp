...
**_Warning!_**: Until now, our client, every time he wanted to make a calculation on worldwide sales, made a manual calculation, from scratch, in Excel files, of the exchange value of the currencies. This problem is characterized as  
1. A piece of information that did not exist in the data sources  
2. Evolves historically  
