...
- [DE (Data Engineering)](docs/de.md)  
    - [Prework](docs/de.md#prework)  
    - [Source tables](docs/de.md#source-tables)  
        - [PROWPI001 ETL](docs/de.md#prowpi001-etl)  
        - [PROWPI002 ETL (AdventureWorksDW2022 DB)](docs/de.md#prowpi002-etl-adventureworksdw2022-db)  
        - [PROWPI002 ETL (parametric data)](docs/de.md#prowpi002-etl-parametric-data)  
